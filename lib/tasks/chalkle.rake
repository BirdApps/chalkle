begin
  namespace :chalkle do
    ...
    task "migrate_images" => :environment do 
      ...
      channels = Channel.all.select{|c| c.logo.url =~ /^http\:\/\/chalkle\-production\.s3\.amazonaws\.com.*/ }
      ...
      courses = Course.all.select{|c| c.course_upload_image.url =~ /^http\:\/\/chalkle\-production\.s3\.amazonaws\.com.*/ }
