...
describe "Chalkler_stats" do
  ...
  describe "Course activity statistics" do
    ...
    let(:courses)do 
      FactoryGirl.create_list(:course,8, meetup_id: 11111111, name: "test class #{i}", cost: 10, teacher_cost: 5, teacher_payment: 25, start_at: 2.days.ago, status: "Published", max_attendee: 10, channel: channel)
    end
