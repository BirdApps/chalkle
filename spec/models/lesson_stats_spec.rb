...
describe "Chalkler_stats" do
  ...
  describe "Lesson activity statistics" do
    before do
      ...
      lesson1 = FactoryGirl.create(:lesson, name: "Cancelled lesson 1", status: "Published", start_at: 2.days.ago, cost: 10, channel: @channel)
      lesson1.update_attributes({:visible => false}, :as => :admin)
      lesson2 = FactoryGirl.create(:lesson, name: "Cancelled lesson 2", status: "Published", start_at: 5.days.ago, cost: 10, channel: @channel)
    ...
    it "calculates number of new classes ran" do
      lesson2 = FactoryGirl.create(:lesson, meetup_id: 1234567, name: "test class 1", status: "Published", start_at: 50.days.ago, channel: @channel)
    ...
    it "calculates number of new cancelled classes" do
      lesson = FactoryGirl.create(:lesson, name: "Cancelled lesson 1", status: "Published", start_at: 10.days.ago, cost: 10, channel: @channel)
    ...
    it "calculates number of paid classes ran" do
      lesson2 = FactoryGirl.create(:lesson, meetup_id: 1234567, name: "test class 1", status: "Published", start_at: 2.days.ago, cost: 0, channel: @channel)
    ...
    it "calculates number of paid classes ran in previous time period" do
      lesson2 = FactoryGirl.create(:lesson, meetup_id: 1234567, name: "test class 1", status: "Published", start_at: 5.days.ago, cost: 0, channel: @channel)
