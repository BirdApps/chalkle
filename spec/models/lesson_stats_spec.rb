...
describe "Chalkler_stats" do
  ...
  describe "Lesson activity statistics" do
    ...
    it "calculates percentage change in number of classes ran" do
      @channel.channel_stats(3.days.ago,3.days).lesson_stats.percent_lessons_ran.should == (2.0/3.0*100.0)
    end
    ...
    it "calculates percentage change in paid lessons ran" do
      @channel.channel_stats(3.days.ago,3.days).lesson_stats.percent_paid_lessons.should == (2.0/3.0*100.0)
    end
