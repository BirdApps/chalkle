...
When /^they enter new class suggestion details$/ do
  fill_in 'course_suggestion_name', with: 'new class suggestion'
  select 'Science', from: 'course_suggestion_category_id'
  fill_in 'course_suggestion_description', with: 'I suggest learning new stuff'
