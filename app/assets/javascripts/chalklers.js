...
$(function() {
  ...
  function calculate_class_times() {
    if(instance_date && instance_time && duration_hours && duration_minutes){
      ...
      repeat_times = $("#teaching_repeat_times").val();
      if(repeating && repeat_times) {
          if(monthly){
  ...
  function update_durations(){
    duration_hours = $('#teaching_duration_hours').val();
    duration_minutes = $('#teaching_duration_minutes').val();
    calculate_class_times();
  }
  ...
  function repeating_course_init() {
    ...
    $('#teaching_duration_minutes').change(update_durations);
    $('#teaching_duration_hours').change(update_durations);
  }
