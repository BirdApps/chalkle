class Teaching
  ...
  :availabilities, :prerequisites, :additional_comments, :venue, :category_primary_id, :suggested_audience
  ...
  def lesson_args
    ...
    "additional_comments" => @additional_comments, "venue" => @venue, "status" => "Unreviewed", "suggested_audience" => @suggested_audience}
  end
