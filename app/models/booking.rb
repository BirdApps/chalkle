class Booking < ActiveRecord::Base
  ...
  validates_presence_of :lesson_id, :chalkler_id, :payment_method, :status, :visible, :paid
  ...
  delegate :name, :start_at, :venue, :prerequisites, :teacher_id, :to => :lesson, prefix: true
