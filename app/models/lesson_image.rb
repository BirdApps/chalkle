class LessonImage < ActiveRecord::Base
  ...
  def generate
    ...
    self.image.convert!(" \( -gravity center -font #{Rails.root}/app/assets/fonts/mrchalk.ttf -background none -fill '#AAAAAA' -size 440x350 label:\"#{title}\" +distort SRT '%[fx:w/2],%[fx:h/2] 1 354 215,225' \) -flatten")
